#!/usr/bin/env python3
"""
Entailment测试 - 只测试能正常工作的模型
跳过qwen模型，只测试gpt-4o, gemma3-12b, gemini-2.5-flash, gemma3-27b
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('entailment_test_working_models.log'),
...
def main():
    """主函数"""
    logging.info("开始Entailment Test - 只测试能正常工作的模型")
    logging.info(f"测试模型: {', '.join(TEST_MODELS)}")
    ...
    report_file = f"entailment_test_results_working_models_{timestamp}.json"
    ...
    # 生成Markdown报告
    report_md = f"entailment_test_report_working_models_{timestamp}.md"
    with open(report_md, 'w', encoding='utf-8') as f:
        f.write("# Entailment Test Report - Working Models Only\n\n")
